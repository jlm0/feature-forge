...
**What:** Agents ask clarifying questions while working **When:** Uncertainty arises, multiple valid paths, user could
provide shortcuts **How:** AskUserQuestion tool with multiple-choice options **Behavior:** Agent pauses, gets answer,
continues work
...
**What:** Explicit approval gates before major transitions **When:** Phase group completes, significant investment ahead
**How:** Present summary, request approval **Behavior:** Work stops until human approves or requests changes
